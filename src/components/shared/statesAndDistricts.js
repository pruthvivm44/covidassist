export const StatesAndDistricts = [{'state':'Andhra Pradesh','districts':['Anantapur','Chittoor','East Godavari','Guntur','Kadapa','Krishna','Nellore','Prakasam','Srikakulam','Visakhapatnam','Vizianagaram','West Godavari']},
{'state':'Arunachal Pradesh','districts':['Changlang','Upper Dibang Vally','East Kameng','Lohit','Lower Subansiri','Papum-Pare','Tawang','Tirap','Upper Siang','Upper Subansiri','West Kameng','West Siang','Anjaw','Lower Dibang Vally','Kurung Kumey']},
{'state':'Assam','districts':['Baksa','Barpeta','Biswanath','Bongaigaon','Cachar','Charaideo','Chirang','Darrang','Dhemaji','Dhubri','Dibrugarh','Dima Hasao (North Cachar Hills)','Goalpara','Golaghat','Hailakandi','Hojai','Jorhat','Kamrup','Kamrup Metropolitan','Karbi Anglong','Karimganj','Kokrajhar','Lakhimpur','Majuli','Morigaon','Nagaon','Nalbari','Sivasagar','Sonitpur','South Salamara-Mankachar','Tinsukia','Udalguri','West Karbi Anglong']},
